...
- Rigid vocabularies leads to slower data collection (OMOP needs to be defined first) → i.e., waterfall
...
- **Serving:** **Athena** standard vocabularies + **ATLAS** OMOP CDMs explorarion to define cohorts
